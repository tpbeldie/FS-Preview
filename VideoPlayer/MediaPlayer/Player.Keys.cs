...
namespace FSPreview.MediaPlayer
{
    partial class Player
    {
        ...
        private void WinFormsHost_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            KeyUp(((FsPlayer)((WindowsFormsHost)sender).Child).Player, e);
        }
        private void WinFormsHost_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            KeyDown(((FsPlayer)((WindowsFormsHost)sender).Child).Player, e);
        }
        ...
        private void Control_KeyUp(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            ...
            //Log("Control_KeyUp");
            KeyUp(((FsPlayer)sender).Player, e);
        }
        private void Control_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            ...
            //Log("Control_KeyDown");
            KeyDown(((FsPlayer)sender).Player, e);
        }
    }
