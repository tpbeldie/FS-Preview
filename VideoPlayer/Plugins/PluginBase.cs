...
namespace FSPreview.Plugins
{
    ...
    {
        // public SerializableDictionary<string, string> DefaultOptions  { get; set; } = new SerializableDictionary<string, string>();

        public SerializableDictionary<string, string> Options => Config?.Plugins[Name];
        ...
        public void Log(string msg) { 
            Debug.WriteLine($"[{DateTime.Now.ToString("hh.mm.ss.fff")}] [#{Handler.UniqueId}] [Plugin: {Name}] {msg}"); 
        }
    }
